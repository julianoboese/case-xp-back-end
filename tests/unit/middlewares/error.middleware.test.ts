...
describe('The AuthMiddleware "auth" function', () => {
  ...
  it('should respond with status code 401', async () => {
    ...
    ErrorMiddleware.handleError(errorMock as HttpError, requestMock as Request, responseMock as unknown as Response, nextMock as NextFunction)
  ...
  it('should respond with a custom error message', async () => {
    ...
    expect(responseMock.json).toHaveBeenCalledWith({ message: 'Acesso não autorizado.' });
  });
